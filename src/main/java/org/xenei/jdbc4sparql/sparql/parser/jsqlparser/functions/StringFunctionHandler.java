...
public class StringFunctionHandler extends AbstractFunctionHandler
{
	...
	public boolean handle( final Function func ) throws SQLException
	{
		...
		{
			case LENGTH:
				handleExpr1(E_StrLength.class, func, java.sql.Types.VARCHAR);
				break;
			case SUBSTRING:
				handleSubString(func);
				break;
			case UCASE:
				handleExpr1(E_StrUpperCase.class, func, java.sql.Types.VARCHAR);
				break;
			case LCASE:
				handleExpr1(E_StrLowerCase.class, func, java.sql.Types.VARCHAR);
				break;
			case REPLACE:
				handleReplace(func);
				break;
		...
		builder.registerFunction(tblName.getColumnName(func.getName()),
				java.sql.Types.VARCHAR);
		return true;
	}

	protected void handleReplace( final Function func ) throws SQLException
	{
	...
	protected void handleSubString( final Function func ) throws SQLException
	{
		final ExpressionList l = func.getParameters();
