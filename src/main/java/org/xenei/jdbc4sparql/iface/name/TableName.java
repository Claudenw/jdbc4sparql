...
public class TableName extends ItemName {
	...
	/**
	 * Create an instance of a TableName given a potentially fully qualified name and
	 * default catalog and schema names.
	 * The name may consist of the table name by itself, or a schema name and the table name
	 * separated by either a JDBC or a SPARLQ "dot" character.
	 * If the name contains the schema name the schema parameter may be null.
	 ...
	 * @param catalog The default catalog name string. may not be null.
	 * @param schema The default schema name string. may be null if name contains schema segment.
	 * @param name the potentially fully qualified name. may not be null.
	 * @return The TableName.
	 * @throws IllegalArgumentException if any conditions fail.
	 */
	 ...
	 * Checks that the itemName table, schema and catalog name segments are not null.
	 ...
	 */
	public TableName(final ItemName name, NameSegments segments)  throws IllegalArgumentException{
	 ...
	 * Uses the default namesegments for a table.
	 ...
	 * @throws IllegalArgumentException
	 */
	public ColumnName getColumnName(final String column) throws IllegalArgumentException {
