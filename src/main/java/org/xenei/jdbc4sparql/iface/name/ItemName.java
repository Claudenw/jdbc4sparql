...
/**
 * A name for an item in a JDBC query. This name wraps an FQName for the
 * underlying object with an FQName used in the query. The FQName used in the
...
public abstract class ItemName implements GUIDObject {
	 ...
	 *            value.
	 * @param segment
	 *            the segment we are checking.
	 * @return the value
	 * @Throws IllegalArgumentException if a null value is passed
	 */
	public static String checkNotNull(final String value, final String segment)
	...
	public static final ItemName WILD = new ItemName("", "", "", "",
		...
		@Override
		public void setUsedSegments(final NameSegments usedSegments) {
	 ...
	 * @throws IllegalArgumentException
	 */
	protected ItemName(final ItemName name, final NameSegments segments)
			throws IllegalArgumentException {
		if (name == null) {
