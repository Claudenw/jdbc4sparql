...
public class ConfigSave
{
	 ...
	 * jdbc:j4s?builder=org.xenei.jdbc4sparql.sparql.builders.SimpleNullableBuilder&type=turtle:file:./J4SStatementTest.ttl
	 * 
	...
	public static void main( final String[] args ) throws Exception
	{
		...
		{
			f = new File( new File( System.getProperty("java.io.tmpdir")),"config.zip");
		}
