...
// ((NodeValueString)((E_Equals)((E_LogicalAnd)expr).getArg2()).getArg1()).asString());
...
// ((NodeValueString)((E_Equals)eAnd.getArg1()).getArg1()).asString());
...
// ((NodeValueString)((E_Equals)eOr.getArg2()).getArg1()).asString());
...
// ((NodeValueString)((E_Equals)eOr.getArg1()).getArg1()).asString());
//
// }
// }
